...
public class Marino : Enemy {
	...
	void Start ()
    {
        ...
        options.Add("Ah, right. You were with the mob. If there is any correlation, it would help to speak up.\n");
        options.Add("Say that I trust you're here for other, decent reasons. Will you deny a possible connection?\n");
        ...
        options.Add("Maybe so. But, I still get the feeling you're hiding something.\n");
        ...
        options.Add("You have to tell me that part of your history, then. Come on, man.\n");
        ...
        dialogue.Add("\"I'm connected with the boy through family, but he's isn't the only reason I attend.\"\n");
        options.Add("But. Are you sure? Are you trying to obscure your connection to our victim?\n");
        options.Add("Did you intend to pay off a residual debt, or maybe settle a score?\n");
        options.Add("Why else do you attend such a wild event for? Surely, you are not a believer of the supernatural.\n");
        options.Add("It's alright to admit you aren't quite free of your criminal roots. Are you looking for liberation?\n");
        dialogue.Add("\"People come to these events seeking all kinds of things. I guess I'm looking for freedom...of a sort.\"\n");
        types.Add(4); // <- replace with 1(concede)/2(stand)/3(aggress)/4(insult) depending on the tone of enemy response.
        ...
        options.Add("I think you've helped, in whatever way you can. I hope you get the forgiveness you desire.\n");//here is where the script ends
        dialogue.Add("\"I'm just a man with a checkered past. If you are finished, I ask that you leave me be.\"\n");
        types.Add(4); // <- replace with 1(concede)/2(stand)/3(aggress)/4(insult) depending on the tone of enemy response.
